...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/14 16:34:00 by mmiilpal          #+#    #+#             */
/*   Updated: 2025/08/14 16:35:16 by mmiilpal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define RST "\033[0m"                   // Reset Couleur
...
# define SOUL "\033[4m"                  // Souligné
# define BLKS "\033[5m"                  // Clignote (lent)
# define BLKF "\033[6m"                  // Clignote (lent)
# define BARR "\033[9m"                  // Barré
